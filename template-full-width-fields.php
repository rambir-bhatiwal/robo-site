<?php
/**
 * Template Name: Full Width + Custom Fields
 * Description: A custom full-width page template that displays custom metadata fields in a responsive table.
 *
 * @package Robo
 */
		...
		<div class="<?php echo esc_attr( $container_class ); ?>">
			...
			while ( have_posts() ) :
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					if ( ! empty( $custom_fields_data ) ) :
						?>
						<div class="custom-fields-table-wrapper mt-5">
