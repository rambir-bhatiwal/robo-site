					...
					<div class="sticky-top" style="top: 100px; z-index: 10;">
						...
						<div class="card border-0 shadow-sm rounded-4 p-4 mb-4 bg-white">
							<h5 class="fw-bold mb-4 border-bottom pb-2 text-dark">
								<span class="dashicons dashicons-info me-2 text-success"></span><?php esc_html_e( 'Code Details', 'robo' ); ?>
							</h5>
							...
							<ul class="list-unstyled mb-0">
								<?php if ( $diff_label ) : ?>
									<li class="d-flex align-items-center justify-content-between py-2 border-bottom">
										...
										<span class="fw-bold text-success"><?php echo esc_html( $diff_label ); ?></span>
									</li>
								<?php endif; ?>
								...
								<li class="d-flex align-items-center justify-content-between py-2">
									<span class="text-muted"><i class="dashicons dashicons-admin-users me-1"></i><?php esc_html_e( 'Developer:', 'robo' ); ?></span>
