...
<div class="about-template-wrapper bg-light-subtle pb-5">
	<!-- Hero Section -->
	<section class="about-hero bg-dark text-white py-5 text-center position-relative overflow-hidden mb-5" style="background: linear-gradient(135deg, #090F1d 0%, #0052FF 100%) !important;">
	...
	<section class="our-story mb-5">
		<div class="<?php echo esc_attr( $container_class ); ?>">
			<div class="row g-5 align-items-center">
				<div class="col-lg-6">
					<span class="text-primary text-uppercase fw-bold small tracking-wider mb-2 d-block"><?php esc_html_e( 'Our Journey', 'robo' ); ?></span>
					<h2 class="h1 fw-bold text-dark mb-4"><?php esc_html_e( 'The RoboScaler Story', 'robo' ); ?></h2>
					<div class="our-story-text text-muted mb-4 fs-6 lh-lg">
						<?php
						if ( have_posts() ) {
							while ( have_posts() ) {
								the_post();
