			...
			<div class="row g-4">
				...
				<div class="col-lg-8">
					<article id="post-<?php the_ID(); ?>" <?php post_class( 'card border-0 shadow-sm rounded-4 p-4 p-md-5 mb-5 bg-white' ); ?>>
						...
						<!-- Video Repeater Gallery -->
						<?php Render::resource_gallery( $post_id, 'learning-video' ); ?>
					</article>
					...
					<div class="sticky-top" style="top: 100px; z-index: 10;">
						...
						<div class="card border-0 shadow-sm rounded-4 p-4 mb-4 bg-white">
							<h5 class="fw-bold mb-4 border-bottom pb-2 text-dark">
								<span class="dashicons dashicons-info me-2 text-danger"></span><?php esc_html_e( 'Course Overview', 'robo' ); ?>
							</h5>
							...
							<ul class="list-unstyled mb-0">
								<?php if ( $diff_label ) : ?>
									<li class="d-flex align-items-center justify-content-between py-2 border-bottom">
										...
										<span class="fw-bold text-danger"><?php echo esc_html( $diff_label ); ?></span>
									</li>
								<?php endif; ?>
								...
								<li class="d-flex align-items-center justify-content-between py-2">
									<span class="text-muted"><i class="dashicons dashicons-admin-users me-1"></i><?php esc_html_e( 'Instructor:', 'robo' ); ?></span>
