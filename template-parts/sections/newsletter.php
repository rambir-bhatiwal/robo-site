	...
	<div class="<?php echo esc_attr( $container_class ); ?> py-4 text-center">
		<div class="row justify-content-center">
			<div class="col-lg-7">
				...
				<!-- Icon Wrapper -->
				<div class="newsletter-icon mb-4 text-white bg-white bg-opacity-10 d-inline-flex align-items-center justify-content-center rounded-circle" style="width: 70px; height: 70px;">
